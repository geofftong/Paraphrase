...
public class DependencyParse {
  ...
  public static final String TAGGER_MODEL = "stanford-tagger-full/models/chinese-distsim.tagger";
  public static final String PARSER_MODEL = "edu/stanford/nlp/models/parser/nndep/CTB_CoNLL_params.txt.gz";
